...
#welcome{
    ...
    background-image: url("Textures and patterns-bg.jpg");
          ...
          <!--Container for the nav links and header-->
            ...
            <div class="container">
               ...
               <section id="header2">
                ...
                <a href="Textures&Patterns.php"><u>Textures & Patterns</u></a>
               ...
               <section id="welcome">
                ...
                <p>From epic drone shots to inspiring moments in nature — submit your best</p>
                 ...
                 <!--
                <p><button type="submit" id="btn-submit">Submit to <b>Textures&Patterns</b></button></p>
-->   
            </section>
