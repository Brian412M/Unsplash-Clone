...
#welcome{
    ...
    background-image: url("https://images.unsplash.com/photo-1673940308551-65b7fe1c2226?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1632&q=80");
        ...
        <div class="header">
          <!--Container for the nav links and header-->
            ...
            <div class="container">
                ...
                <!--logo-->
                <img src="image-1.jpg" id="logo" width="30px" height="40px">
                ...
                <a href="Trends.php" id="links" class="link3">Trending Today</a>
               ...
               <section id="welcome">
                ...
                <p>From epic drone shots to inspiring moments in nature — submit your best</p>
                 ...
                 <!--
                <p><button type="submit" id="btn-submit">Submit to <b>Wallpapers</b></button></p>
                -->   
            </section>
